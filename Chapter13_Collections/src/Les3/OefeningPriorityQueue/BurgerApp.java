package Les3.OefeningPriorityQueue;
...
public class BurgerApp {
 ...
 // private static void processOrder(Queue<BurgerOrder> burgerOrders) {
 //     while (!burgerOrders.isEmpty()) {
 //         BurgerOrder order = burgerOrders.poll();
 //         if (order == null) ;
 //         System.out.println("Bestelingen voor " + order.getNaam() + " met nummer " + order.getNummer());
 //     }
    }
}
