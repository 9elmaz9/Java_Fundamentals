...
//CalculatorProgram
public class Opdracht1CalculatorProgram {
    public static void main(String[] args) {
        ...
        } else if (age >= 10) {//b-Als de leeftijd >=10 maar <18, wordt het volgende bericht afgedrukt:You are a teenager
            System.out.println("You are a teenager");
        } else if (age >= 2 ){///c-Als de leeftijd >=2 maar <10, wordt het volgende bericht afgedrukt: You are a child
